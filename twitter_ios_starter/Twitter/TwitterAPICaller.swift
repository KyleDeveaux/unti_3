...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "6MLqQdc9B0dPuiJYYxY4OKREC", consumerSecret: "TewYpJ4snvFVdFDMgviPhyGaNkuCjVk3fSwo0Msp4QJlXEZiLe")
    var loginSuccess: (() -> ())?
